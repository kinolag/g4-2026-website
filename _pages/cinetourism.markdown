...
## 1. Definizione e Complessità del Fenomeno
Il CineTourism, o turismo cinematografico, rappresenta una forma peculiare di turismo esperienziale in cui la destinazione geografica funge da catalizzatore per il coinvolgimento emotivo dei visitatori. Non si tratta meramente della visita a un set cinematografico, bensì di un processo di "de-territorializzazione" e "ri-territorializzazione": la realtà fisica del luogo viene sovrapposta all'immaginario narrativo creato dalla produzione mediatica, trasformando luoghi comuni in icone culturali[cite: 1]. 

Il fenomeno si manifesta attraverso tre direttrici principali:
* **Il pellegrinaggio narrativo:** I turisti cercano di ripercorrere i passi dei protagonisti, cercando una connessione diretta con la finzione[cite: 1].
* **L'estetica della destinazione:** Il luogo acquisisce valore grazie alla fotografia cinematografica, che spesso "estetizza" il territorio, rendendolo attraente oltre i suoi confini tradizionali[cite: 1].
* **L'effetto "Halo":** L'influenza positiva di un film di successo che si irradia su tutto il comparto turistico circostante, aumentando la notorietà del brand-paese[cite: 1].

## 2. Il Paradosso della Visibilità: Perché è Importante?
...
Il nostro approccio metodologico non si limita a osservare il picco delle presenze, ma mira a decodificare la "salute" della destinazione attraverso l'analisi dei dati[cite: 1].

Come illustrato nelle nostre **charts.markdown**, il ciclo di vita di una destinazione CineTuristica segue spesso un pattern di "flash-flood":
1. **Lancio della produzione:** Generazione di entusiasmo mediatico e alta visibilità sui social[cite: 1].
2. **Picco dei visitatori:** Inizio dello stress infrastrutturale e prime frizioni con le comunità residenti[cite: 1].
